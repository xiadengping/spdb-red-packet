...
var contactProto = {
  init: function init(instance) {
    this.NickName = (0, _util.convertEmoji)(this.__proto__.NickName);
    this.RemarkName = (0, _util.convertEmoji)(this.__proto__.RemarkName);
    this.DisplayName = (0, _util.convertEmoji)(this.__proto__.DisplayName);
