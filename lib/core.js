...
var WechatCore = function () {
  function WechatCore() {
    (0, _classCallCheck3.default)(this, WechatCore);
  ...
  (0, _createClass3.default)(WechatCore, [{
    key: 'getUUID',
    value: function getUUID() {
      ...
      return Promise.resolve().then(function () {
        return _this.request({
          ...
          return _this.PROP.uuid = window.QRLogin.uuid;
        });
      }).catch(function (err) {
        debug(err);
      ...
      return Promise.resolve().then(function () {
        ...
        return _this2.request({
          ...
          if (window.code == 200) {
            ...
            _this2.user.userAvatar = window.userAvatar;
          }
          return window;
        });
      }).catch(function (err) {
    ...
    key: 'uploadMedia',
    value: function uploadMedia(file, filename) {
      var _this14 = this;
      ...
      return Promise.resolve().then(function () {
        ...
        return new Promise(function (resolve, reject) {
          ...
          var uploadMediaRequest = JSON.stringify({
            ...
            ToUserName: _this14.user.UserName
          });
    ...
    value: function getMsgImg(msgId) {
      ...
      return Promise.resolve().then(function () {
        var params = {
          MsgID: msgId,
          skey: _this18.PROP.skey,
          type: 'big'
        };

        return _this18.request({
          method: 'GET',
          url: _this18.CONF.API_webwxgetmsgimg,
          params: params,
    ...
    value: function getVideo(msgId) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this19.request({
          method: 'GET',
          url: _this19.CONF.API_webwxgetvideo,
          headers: {
            'Range': 'bytes=0-'
          },
          params: params,
    ...
    value: function getVoice(msgId) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this20.request({
          method: 'GET',
          url: _this20.CONF.API_webwxgetvoice,
          params: params,
          responseType: 'arraybuffer'
        }).then(function (res) {
          return {
    ...
    value: function getHeadImg(HeadImgUrl) {
      ...
      return Promise.resolve().then(function () {
        var url = _this21.CONF.origin + HeadImgUrl;
    ...
    value: function verifyUser(UserName, Ticket) {
      ...
      return Promise.resolve().then(function () {
        var params = {
          'pass_ticket': _this22.PROP.passTicket,
          'lang': 'zh_CN'
        };
        var data = {
          'BaseRequest': _this22.getBaseRequest(),
          'Opcode': 3,
        ...
        return _this22.request({
          method: 'POST',
          url: _this22.CONF.API_webwxverifyuser,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    key: 'updateChatroom',
    value: function updateChatroom(ChatRoomName, MemberList, fun) {
      var _this23 = this;
      ...
      return Promise.resolve().then(function () {
        ...
        var data = {
          BaseRequest: _this23.getBaseRequest(),
        ...
        return _this23.request({
          method: 'POST',
          url: _this23.CONF.API_webwxupdatechatroom,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    key: 'opLog',
    value: function opLog(UserName, OP) {
      var _this24 = this;
      ...
      return Promise.resolve().then(function () {
        ...
        return _this24.request({
          method: 'POST',
          url: _this24.CONF.API_webwxoplog,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
